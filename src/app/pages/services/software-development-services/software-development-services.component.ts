...
@Component({
  selector: 'app-software-development-services',
  standalone: true,
  imports: [FaqComponent, RouterModule],
  templateUrl: './software-development-services.component.html',
  styleUrl: './software-development-services.component.css'
})
export class SoftwareDevelopmentServicesComponent  implements AfterViewInit {
