...
@Component({
  selector: 'app-it-staffing-services',
  standalone: true,
  imports: [FaqComponent, RouterModule],
  templateUrl: './it-staffing-services.component.html',
  styleUrl: './it-staffing-services.component.css'
})
export class ItStaffingServicesComponent implements AfterViewInit {
