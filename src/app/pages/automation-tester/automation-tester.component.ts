...
@Component({
  selector: 'app-automation-tester',
   standalone: true,
    imports: [RouterModule, FormsModule, CommonModule],
  templateUrl: './automation-tester.component.html',
  styleUrl: './automation-tester.component.css'
})
export class AutomationTesterComponent {
