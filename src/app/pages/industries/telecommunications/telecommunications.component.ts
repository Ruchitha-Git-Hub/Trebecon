...
@Component({
  selector: 'app-telecommunications',
  standalone: true,
imports: [FaqComponent, RouterModule],
  templateUrl: './telecommunications.component.html',
  styleUrl: './telecommunications.component.css'
})
export class TelecommunicationsComponent implements AfterViewInit {
