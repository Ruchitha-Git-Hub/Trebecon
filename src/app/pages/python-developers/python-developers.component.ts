...
@Component({
  selector: 'app-python-developers',
   standalone: true,
imports: [RouterModule, FormsModule, CommonModule],
  templateUrl: './python-developers.component.html',
  styleUrl: './python-developers.component.css'
})
export class PythonDevelopersComponent {
